...
VENUES = {
    ...
    "os": [("OSDI", "OSDI", 60), ("SOSP", "SOSP", 50), ("EuroSys", "EuroSys", 50), ("USENIX Annual Technical Conference", "USENIX ATC", 50),
           ("FAST", "FAST", 30)],
    "pl": [("PLDI", "PLDI", 60), ("POPL", "POPL", 50), ("OOPSLA", "OOPSLA", 50), ("ICFP", "ICFP", 30), ("CGO", "CGO", 20)],
    "db": [("SIGMOD", "SIGMOD", 70), ("VLDB", "VLDB", 70), ("ICDE", "ICDE", 50), ("PODS", "PODS", 20)],
    "arch": [("ISCA", "ISCA", 60), ("MICRO", "MICRO", 50), ("ASPLOS", "ASPLOS", 60), ("HPCA", "HPCA", 50)],
    "security": [("IEEE Symposium on Security and Privacy", "IEEE S&P", 60), ("CCS", "CCS", 60), ("USENIX Security Symposium", "USENIX Security", 60), ("NDSS", "NDSS", 50)],
    "se": [("ICSE", "ICSE", 70), ("FSE", "FSE", 50), ("ASE", "ASE", 50), ("ISSTA", "ISSTA", 30)],
    "theory": [("STOC", "STOC", 50), ("FOCS", "FOCS", 50), ("SODA", "SODA", 40)],
    "crypto": [("CRYPTO", "CRYPTO", 40), ("EUROCRYPT", "EUROCRYPT", 40), ("ASIACRYPT", "ASIACRYPT", 20)],
    "logic": [("CAV", "CAV", 40), ("LICS", "LICS", 30)],
    "eda": [("DAC", "DAC", 50), ("ICCAD", "ICCAD", 40)],
    "embedded": [("EMSOFT", "EMSOFT", 20), ("RTSS", "RTSS", 30), ("RTAS", "RTAS", 20)],
    "metrics": [("SIGMETRICS", "SIGMETRICS", 40), ("Performance", "Performance", 20)],
    "ir": [("SIGIR", "SIGIR", 70), ("The Web Conference", "WWW", 60), ("KDD", "KDD", 60), ("WSDM", "WSDM", 30)],
    "graphics": [("SIGGRAPH", "SIGGRAPH", 80), ("SIGGRAPH Asia", "SIGGRAPH Asia", 50), ("ACM Transactions on Graphics", "TOG", 50), ("Eurographics", "Eurographics", 30)],
    "vis": [("IEEE Visualization", "VIS", 50), ("IEEE Transactions on Visualization and Computer Graphics", "TVCG", 60), ("IEEE Virtual Reality", "IEEE VR", 40)],
    "bio": [("ISMB", "ISMB", 30), ("RECOMB", "RECOMB", 20), ("Bioinformatics", "Bioinformatics", 40)],
    "econ": [("ACM Conference on Economics and Computation", "EC", 40), ("WINE", "WINE", 20)],
    "speech": [("ICASSP", "ICASSP", 80), ("Interspeech", "Interspeech", 80)],
